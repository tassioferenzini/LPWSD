...
import dao.AssuntoDAOHibernate;
 ...
 * @author tassio
 */
@ManagedBean(name = "TbassuntoBean")
@ViewScoped
public class TbAssuntoBean {
    ...
    public TbAssuntoBean() {
        assuntos = new AssuntoDAOHibernate().getAll();
        assunto = new TbAssunto();
    }

    public void record(ActionEvent actionEvent) {
        new AssuntoDAOHibernate().save(assunto);
        assuntos = new AssuntoDAOHibernate().getAll();
        assunto = new TbAssunto();
    ...
    public void exclude(ActionEvent actionEvent) {
        new AssuntoDAOHibernate().deleteTbAssunto(assunto);
        assuntos = new AssuntoDAOHibernate().getAll();
        assunto = new TbAssunto();
    }
